  ...
  bebidas: {
    ...
    subcategorias: {
      ...
      alcohol: {
        label: "Alcohol",
        productos: [
          { id: "cerveza 1lt", nombre: "Cerveza", unidad: "u" },
          { id: "cerveza Lata", nombre: "Cerveza", unidad: "u" },
          { id: "cerveza Lata 3/4", nombre: "Cerveza", unidad: "u" },
  ...
  salaEnsayo: {
    ...
    subcategorias: {
      salaEnsayo: {
        label: "Sala Ensayo",
        productos: [
          { id: "sala_ensayo", nombre: "Sala de ensayo", unidad: "hs" },
     ], },
